...
class ejabberdctl(object):
    ...
    def ban_account(self, user, host, reason):
        ...
        """
        return self.ctl("ban_account", {"user": user, "host": host, "reason": reason})
    ...
    def change_password(self, user, host, newpass):
        ...
        """
        return self.ctl(
            "change_password", {"user": user, "host": host, "newpass": newpass}
        )

    def change_room_option(self, name, service, option, value):
        return self.ctl(
            "change_room_option",
            {"name": name, "service": service, "option": option, "value": value},
        )
    ...
    def check_password(self, user, host, password):
        ...
        """
        return self.ctl(
            "check_password", {"user": user, "host": host, "password": password}
        )
    ...
    def create_room_with_opts(self, name, service, host, options):
        return self.ctl(
            "create_room",
            {"name": name, "service": service, "host": host, "options": options},
        )
    ...
    def delete_old_users_vhost(self, host, days):
        ...
        """
        return self.ctl("delete_old_users_vhost", {"host": host, "days": days})
    ...
    def get_vcard(self, user, host, name):
        ...
        """
        return self.ctl("get_vcard", {"user": user, "host": host, "name": name})
    ...
    def get_vcard2(self, user, host, name, subname):
        ...
        """
        return self.ctl(
            "get_vcard2", {"user": user, "host": host, "name": name, "subname": subname}
        )
    ...
    def get_vcard2_multi(self, user, host, name, subname):
        ...
        return self.ctl(
            "get_vcard2_multi",
            {"user": user, "host": host, "name": name, "subname": subname},
        )
    ...
    def kick_session(self, user, host, resource, reason):
        ...
        return self.ctl(
            "kick_session",
            {"user": user, "host": host, "resource": resource, "reason": reason},
        )
    ...
    def register(self, user, host, password):
        ...
        Register a user
        """
        return self.ctl("register", {"user": user, "host": host, "password": password})
    ...
    def resource_num(self, user, host, num):
        ...
        """
        return self.ctl("resource_num", {"user": user, "host": host, "num": num})
    ...
    def send_stanza_c2s(self, user, host, resource, stanza):
        ...
        return self.ctl(
            "send_stanza_c2s",
            {"user": user, "host": host, "resource": resource, "stanza": stanza},
        )
    ...
    def set_last(self, user, host, timestamp, status):
        ...
        return self.ctl(
            "set_last",
            {"user": user, "host": host, "timestamp": timestamp, "status": status},
        )
    ...
    def set_nickname(self, user, host, nickname):
        ...
        """
        return self.ctl(
            "set_nickname", {"user": user, "host": host, "nickname": nickname}
        )
    ...
    def set_vcard(self, user, host, name, content):
        ...
        """
        return self.ctl(
            "set_vcard", {"user": user, "host": host, "name": name, "content": content}
        )
    ...
    def srg_user_add(self, user, host, group, grouphost):
        ...
        return self.ctl(
            "srg_user_add",
            {"user": user, "host": host, "group": group, "grouphost": grouphost},
        )
    ...
    def stop_kindly(self, delay, announcement):
        ...
        """
        return self.ctl("stop_kindly", {"delay": delay, "announcement": announcement})
